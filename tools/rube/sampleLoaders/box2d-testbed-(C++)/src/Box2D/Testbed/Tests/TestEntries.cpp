...
#include "loadrube.h"
#include "loadrube_customProperties.h"
#include "loadrube_jointTypes.h"

TestEntry g_testEntries[] =
{
    {"Load RUBE", LoadRUBE::Create},
    {"Load RUBE (custom properties)", LoadRUBE_CustomProperties::Create},
    {"Load RUBE (joint types)", LoadRUBE_jointTypes::Create},
