...
@interface PinballRUBELayer : RUBELayer
{
    ...
    UITouch* m_leftFlipperTouch;                                // used to keep track of which flipper buttons are currently pressed (if this is nil, the button is not pressed)
    UITouch* m_rightFlipperTouch;                               // used to keep track of which flipper buttons are currently pressed (if this is nil, the button is not pressed)
    ...
    CCSprite* m_ballSprite;                                     // need this to reorder the ball sprite when the ball changes levels, to make it look like it is going under the upper level properly
